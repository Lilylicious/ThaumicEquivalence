...
public class TEConfig
{
    ...
    public static void init(File configFile)
    {
        ...
        try
        {
            ...
            mode = config.getInt("hardMode", "mode", 1, 0, 1, "0 means just EMC values, 1 means hard mode");
            //EMC
            ...
            infusionInstabilityEMC = config.getBoolean("infusionInstabilityEMC", "emc", true, "Adds EMC to infusion itemsToRemove based on instability");
