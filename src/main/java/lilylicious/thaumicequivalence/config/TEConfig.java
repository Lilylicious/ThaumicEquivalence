...
public class TEConfig
{
	...
	public static void init(File configFile)
	{
		...
		try
		{
			...
			//Modules
			enableRecipes = config.getBoolean("recipes", "WIP!! modules", false, "Enable thaumcraft recipes for ProjectE items");
			enableResearch = config.getBoolean("research", "WIP!! modules", false, "Enable thaumcraft research for ProjectE items");
			...
			//Default Values
			aerValue = config.getInt("aerValue", "defaultValues", 10, 0, Integer.MAX_VALUE, "The default value of aer");
			terraValue = config.getInt("terraValue", "defaultValues", 10, 0, Integer.MAX_VALUE, "The default value of terra");
			ignisValue = config.getInt("ignisValue", "defaultValues", 10, 0, Integer.MAX_VALUE, "The default value of ignis");
			aquaValue = config.getInt("aquaValue", "defaultValues", 10, 0, Integer.MAX_VALUE, "The default value of aqua");
			ordoValue = config.getInt("ordoValue", "defaultValues", 10, 0, Integer.MAX_VALUE, "The default value of ordo");
			perditioValue = config.getInt("perditioValue", "defaultValues", 10, 0, Integer.MAX_VALUE, "The default value of perditio");
			...
			amberValue = config.getInt("amberValue", "defaultValues", 128, 0, Integer.MAX_VALUE, "The default value of Amber");
			knowledgeFragmentValue = config.getInt("knowledgeFragmentValue", "defaultValues", 128, 0, Integer.MAX_VALUE, "The default value of Knowledge Fragments");
			brainValue = config.getInt("brainValue", "defaultValues", 128, 0, Integer.MAX_VALUE, "The default value of Zombie Brains");
			...
			primordialPearlAddition = config.getInt("primordialPearlAddition", "defaultValues", 0, 0, Integer.MAX_VALUE, "The default addition to Primordial Pearl EMC, calculated from the values of primals");
